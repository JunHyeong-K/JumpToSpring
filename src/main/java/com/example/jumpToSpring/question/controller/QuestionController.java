package com.example.jumpToSpring.question.controller;

import com.example.jumpToSpring.answer.AnswerForm;
import com.example.jumpToSpring.question.QuestionForm;
...
import com.example.jumpToSpring.question.service.QuestionService;
...
public class QuestionController {
    ...
    @PostConstruct
    public void init(){
        questionService.create("안녕안녕", "나는 지수야 헬륨가스 먹어서 요렇게 됫지",null);
    }
